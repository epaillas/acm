...
observable = GalaxyPowerSpectrumMultipoles()
k = observable.separation
...
plt.savefig(f'pk_emulator.png', dpi=300, bbox_inches='tight')
plt.close()
...
ax.grid()
plt.tight_layout()
plt.savefig(f'pk_emulator_error.png', dpi=300, bbox_inches='tight')
plt.show()