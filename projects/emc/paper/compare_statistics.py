...
for istat, stat in enumerate(stats):
    data_dir = f'/global/cfs/cdirs/desicollab/users/epaillas/acm/fits_emc/abacus/feb10/c000_hod030/lcdm_McutM1'
...
plt.savefig('compare_statistics_lcdm_McutM1.png', bbox_inches='tight', dpi=300)