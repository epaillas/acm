...
legend_labels.append(r'$P(k) + \overline{n}_g$')
...
chains.append(samples)
maxl = data['samples'][data['log_likelihood'].argmax()]
legend_labels.append(r'$\textrm{+MF+DSC}$')
...
plt.savefig(f'fig/posterior_diffsky_AB_c{cosmo_idx:03}_hod{hod_idx:03}.pdf', bbox_inches='tight')
plt.savefig(f'fig/posterior_diffsky_AB_c{cosmo_idx:03}_hod{hod_idx:03}.png', bbox_inches='tight', dpi=300)
