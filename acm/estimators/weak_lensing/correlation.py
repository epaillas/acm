...
class LensingCorrelation:
    ...
    def kappa_correlation(self, cat1, cat2=None):
        ...
        kk = treecorr.KKCorrelation(min_sep=0.1, max_sep=5, nbins=10, sep_units='degrees', bin_type='Linear')
        cat1 = cat1.treecorr
...
if __name__ == "__main__":
    ...
    kappa_map = AbacusConvergenceMap(snap_idx=47, cosmo_idx=0, phase_idx=0, sim_type='base')
    kappa_map.read_map()
