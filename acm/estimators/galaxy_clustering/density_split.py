...
#             else:
#                 query_positions = self.backend.get_query_positions(method=query_method, nquery=nquery_factor*self.size_data)
#         self.query_method = query_method
#         self.query_positions = query_positions
...
#     def quantile_data_correlation(self, data_positions, return_pycorr=False, **kwargs):
#         """
#         Compute the cross-correlation function between the density field
#         quantiles and the data.
