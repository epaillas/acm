        ...
        **kwargs
        ...
        for i, quantile in enumerate(self._quantiles):
            ...
            spectrum = spectrum.clone(
                norm=norm, **ckwargs
            )  # FIXME: revert ckwargs to explicit arguments if lsstypes allows None args in the future

            spectrum_list.append(spectrum)
            logger.info(f"Q{i} spectrum calculated in {time.time() - t0:.2f} s.")
    ...
    def plot(
        ...
        **kwargs
        ...
        for q in quantiles:
            ...
            ax.plot(ld, pole * ld**2, label=rf"${{\rm Q}}_{q}$", **kwargs)
        return fig, ax
