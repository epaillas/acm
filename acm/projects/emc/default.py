...
emc_paths = {
    ...
    'covariance_dir': '/pscratch/sd/e/epaillas/emc/v1.1/abacus/training_sets/cosmo+hod/',
    # dir of the errors
    'error_dir': '/pscratch/sd/e/epaillas/emc/v1.1/emulator_error/',
    'emulator_covariance_dir': '/pscratch/sd/e/epaillas/emc/v1.1/emulator_error/',
    'save_dir': '/pscratch/sd/e/epaillas/emc/v1.1/emulator_error/',
    # dir of the trained models
    'study_dir': '',
    'model_dir': '/pscratch/sd/e/epaillas/emc/v1.1/trained_models/',
