...
def get_best_model(
    ...
    if copy_to:
        copy_to = copy_to + f'{statistic}/' # ACM standard storage (see train)
...
if __name__ == '__main__':
    ...
    from acm.observables.bgs import *
    study_statistics = {
    ...
    kwargs = {
        'lhc_y': statistic.y,
        'lhc_x': statistic.x,
        'lhc_x_names': statistic.x_names,
        'covariance_matrix': statistic.get_covariance_matrix(),
