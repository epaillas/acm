...
from sunbird.emulators.models.transformer_test import Transformer
from sunbird.emulators import train
...
def TrainTransformer(observable, learning_rate, d_model, nhead, num_layers, dim_feedforward, dropout_rate, weight_decay, 
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Train Transformer for EMC observables.')
    ...
    model_dir = f'/global/cfs/cdirs/desicollab/users/agolinki/acm/emc/models/v1.2/best/{args.statistic}_transformer/'
    TrainTransformer(
