...
#SBATCH --job-name val20-inference
#SBATCH --output /pscratch/sd/s/sbouchar/Output_jobs/bgs-20_inference/validation/%A.%x_%a.out
#SBATCH --error /pscratch/sd/s/sbouchar/Output_jobs/bgs-20_inference/validation/%A.%x_%a.err
