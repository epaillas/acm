...
#SBATCH --job-name prepare_small
#SBATCH --output /pscratch/sd/s/sbouchar/Output_jobs/prepare_sim/small/%A.%x_%a.out
#SBATCH --error /pscratch/sd/s/sbouchar/Output_jobs/prepare_sim/small/%A.%x_%a.err
...
LOG_FOLDER=/pscratch/sd/s/sbouchar/summit_subsamples/lowmass/logs/small/

# Get phase-dependent parameters
