...
#SBATCH --output /global/homes/s/sbouchar/Output_jobs/prepare_sim/small/%A.%x_%a.out
#SBATCH --error /global/homes/s/sbouchar/Output_jobs/prepare_sim/small/%A.%x_%a.err
...
LOG_FOLDER=/pscratch/sd/s/sbouchar/summit_subsamples/logs/small/
